...
public class MenuParser {
    ...
    public MenuParser() throws IOException {
        ...
        Scanner listOfPlaces = new Scanner(new File("src\\main\\java\\ATD\\ListOfPlaces.txt"));
        Scanner diningURLs = new Scanner(new File("src\\main\\java\\ATD\\DiningURLs.txt"));
    ...
    public HashMap<String, HashMap<String, String>> getNutritionalValuesForAllFoods(String URL)
        ...
        System.out.println(overallHashMap);
