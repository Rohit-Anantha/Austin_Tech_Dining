        ...
        return (
            <TouchableOpacity style={{alignItems: 'center'}} onPress={() => navigation.navigate('Test')}>
                <View style={styles.foodItem}>
                    ...
                    <TouchableOpacity style={styles.filterIconOther}>
        ...
        <View style={styles.container}>
           ...
           <SafeAreaView>
                <View style={styles.headerWrapper}>
                    ...
                    <TouchableOpacity style={styles.filterIcon} onPress={toggleSideMenu}>
                        <MaterialIcons name="tune" size={30}/>
                    </TouchableOpacity>
                </View>
            </SafeAreaView>
                    ...
                    <TouchableOpacity style={{alignItems: 'center'}} onPress={() => navigation.navigate('Test')}>
                        <View style={styles.foodItemClicked}>
                            <View>
                                ...
                                <Text style={styles.foodCalories, {marginBottom: 20, color: '#584E4E'}}> calories: 180kcal </Text>
                                <MaterialIcons style={styles.filterIconOther} name="add" size={30}/>
                            </View>
